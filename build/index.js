...
var GifBox = function GifBox(_ref) {
  ...
  if (!currentGif && plugin_settings.tenor_api_key == '') {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__["RichText"].Content, {
      tagName: "p",
      value: sprintf(__('Please enter your Tenor API key on the <a href="%s">settings page</a>.', 'gsae'), plugin_settings.gsae_settings_page)
    });
  }
  ...
  if (!currentGif) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
      ...
      tagName: "p",
      value: __('Use the search in the block settings to find a gif...', 'gsae')
    }));
  }
  ...
  var classes = 'align' + alignment;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "wp-block-image gsae-gif-block"
...
var GifSearch = function GifSearch(_ref) {
  ...
  var keyLabel = sprintf(__('Please enter your Tenor API key on the <a href="%s">settings page</a>.', 'gsae'), plugin_settings.gsae_settings_page); //alt text box
  ...
  if (plugin_settings.tenor_api_key == '') {
    gifSearchInput = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["RichText"].Content, {
      ...
      href: plugin_settings.gsae_settings_page
...
var plugin_settings = gsae_settings; //localized settings from enqueue scripts
    ...
    var setGifSearch = function setGifSearch(newSearchTerm) {
      ...
      if (newSearchTerm) {
        ...
        _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
          path: '/gsae/v1/search/' + newSearchTerm + '/pos/' + pagePos
